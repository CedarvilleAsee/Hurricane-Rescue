...
void displayPositioning(){
 oledDisplay.clearDisplay();
  oledDisplay.setCursor(0,0);
  oledDisplay.println("Going to  position");
  oledDisplay.display();
}
...
void displayTraveling(){
 oledDisplay.clearDisplay();
  oledDisplay.setCursor(0,0);
  oledDisplay.println("Going to  fire");
  oledDisplay.display();
}
...
void displayWaiting(){
 oledDisplay.clearDisplay();
  oledDisplay.setCursor(0,0);
  oledDisplay.println("Wait for  robot to  leave");
  oledDisplay.display();
}

void displayWaiting2(){
 oledDisplay.clearDisplay();
  oledDisplay.setCursor(0,0);
  oledDisplay.println("Wait for  robot to  return");
  oledDisplay.display();
}
